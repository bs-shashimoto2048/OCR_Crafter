...
**状態**: Completed / Closed（Investigation / Documentation only。Production Job lifecycleは無変更）。PR [#136](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/136)、Squash Commit `21a2add`でマージ済み。
