...
- [x] Feature Issue作成・実装完了: Models API（[#44](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/44)、**Completed**・Closed。PR [#45](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/45)Squash Merge済み）
...
- [x] **Epic #28を一旦停止**（2026-07-31、ユーザー判断）。モデル管理・学習・評価画面のUIレビューを実施
- [x] UIレビュー完了確認: Epic #46（Engine UI Generalization、Completed）・Epic #27（TrOCR Lifecycle、Completed）で実質的にカバー済みと確認
- [x] Investigation: Resume Unified Model Metadata Consumer Migration（[#108](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/108)、2026-08-18完了）。現在実装を再調査し、Canonical Metadata基盤は依然Production consumerゼロであること・Consumer Migrationは既存Legacyパスが機能している限り着手を見送るべきことを確認。次Issueは「TrOCR Legacy Metadata Adapter Compatibility」のみを推奨（詳細は[MODEL_METADATA_CONSUMER_MIGRATION_REASSESSMENT_108.md](MODEL_METADATA_CONSUMER_MIGRATION_REASSESSMENT_108.md)参照）
- [x] Feature Issue作成・実装完了: TrOCR Legacy Metadata Adapter Compatibility（[#110](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/110)、**Completed**・Closed。PR [#111](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/111)Squash Merge済み、Merge Commit: `5e51796`）。`TrOCRMetadataAdapter`を`LegacyMetadataAdapter`へ追加し、`MetadataReader`/`ModelCatalog`が`.trocr.json`を扱えるようになった（詳細は[TROCR_LEGACY_METADATA_ADAPTER_110.md](TROCR_LEGACY_METADATA_ADAPTER_110.md)参照）
...
- Feature: [#44](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/44) [Feature] Models API（**Completed**・Closed。PR [#45](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/45)Squash Merge済み）
- Investigation: [#108](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/108) [Investigation] Resume Unified Model Metadata Consumer Migration（Consumer Migration再評価。Productionコード変更なし）
- Feature: [#110](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/110) [Feature] TrOCR Legacy Metadata Adapter Compatibility（**Completed**・Closed。PR [#111](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/111)Squash Merge済み）
...
- [MODEL_METADATA_CONSUMER_MIGRATION_REASSESSMENT_108.md](MODEL_METADATA_CONSUMER_MIGRATION_REASSESSMENT_108.md)（#108のConsumer Migration再評価・Architecture Questions回答・推奨Issue分割）
- [TROCR_LEGACY_METADATA_ADAPTER_110.md](TROCR_LEGACY_METADATA_ADAPTER_110.md)（#110の実装前調査・Field Mapping・Decision Record・テスト結果）
