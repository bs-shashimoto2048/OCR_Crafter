...
**Epic [#28](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/28)は現在Open。** Investigation（[#29](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/29)）完了・Closed。Architecture（[#30](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/30)）設計完了・PRレビュー待ち。
...
- [ ] ADRレビュー・Accepted判断（ユーザー判断）
- [ ] 後続Feature Issue作成（Canonical Schema整備〜Cleanupまで。[ISSUE_MAP.md](ISSUE_MAP.md)参照）
...
- Architecture: [#30](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/30) [Architecture] Unified Model Metadata Adapterと段階的移行方式を設計（設計完了・PRレビュー待ち）
...
- [../../adr/ADR-0002_Unified_Model_Metadata.md](../../adr/ADR-0002_Unified_Model_Metadata.md)（Status: Proposed）
