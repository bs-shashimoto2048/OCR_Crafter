...
- [x] Feature Issue作成・実装完了: Model Catalog（[#40](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/40)、PRレビュー待ち）
- [x] Model Catalog Design Notes作成（[MODEL_CATALOG_DESIGN_NOTES.md](MODEL_CATALOG_DESIGN_NOTES.md)。スコープ決定・将来検討事項を記録）
- [ ] 次のOpen項目: Training/Import時のMetadata生成またはModels連携（[ISSUE_MAP.md](ISSUE_MAP.md)参照）
...
- Feature: [#40](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/40) [Feature] Model Catalog（実装完了・PRレビュー待ち）
