...
- [x] Feature Issue作成・実装完了: TrOCR Legacy Metadata Adapter Compatibility（[#110](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/110)、Implemented, PR review pending）。`TrOCRMetadataAdapter`を`LegacyMetadataAdapter`へ追加し、`MetadataReader`/`ModelCatalog`が`.trocr.json`を扱えるようになった（詳細は[TROCR_LEGACY_METADATA_ADAPTER_110.md](TROCR_LEGACY_METADATA_ADAPTER_110.md)参照）
...
- Feature: [#110](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/110) [Feature] TrOCR Legacy Metadata Adapter Compatibility（Implemented, PR review pending）
