...
- [x] Feature Issue作成・実装完了: Metadata Writer（[#38](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/38)、PRレビュー待ち）
- [ ] 次のOpen項目: Model Catalog実装（[ISSUE_MAP.md](ISSUE_MAP.md)参照）
- [ ] 後続Feature Issue作成（Training/Import Factory〜Cleanupまで）
...
- Feature: [#38](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/38) [Feature] Metadata Writer（実装完了・PRレビュー待ち）
