...
- [ ] **Epic #28を一旦停止**（2026-07-31、ユーザー判断）。モデル管理・学習・評価画面のUIレビューを実施中
- [ ] UIレビュー完了後、次のOpen項目（Consumer切替・Inference連携等）の着手要否を判断（[ISSUE_MAP.md](ISSUE_MAP.md)参照）
