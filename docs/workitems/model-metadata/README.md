...
- [x] Feature Issue作成・実装完了: Training Metadata Factory（[#42](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/42)、実装完了・PRレビュー待ち）
...
- Feature: [#42](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/42) [Feature] Training Metadata Factory（実装完了・PRレビュー待ち）
