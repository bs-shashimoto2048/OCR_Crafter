...
| 6 | ModelMetadata Writer実装 | 3 | Canonical sidecarへの原子的書込（`MetadataWriter`、単純な上書き保存のみ） | **Completed**（[#38](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/38)、PRレビュー待ち） |
