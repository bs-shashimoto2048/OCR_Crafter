...
**状態**: Completed / Closed（Investigation / Documentation only。Production実装は無し）。PR [#153](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/153)、Squash Commit `1cf51c5`でマージ済み。
