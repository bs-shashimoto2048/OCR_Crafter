...
**状態**: Completed・Closed。PR [#101](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/101)をSquash Merge・mainへ反映済み、Merge Commit: `39bf82b`。Issue #100はPR本文の`Closes #100`によりマージ時に自動Close。
