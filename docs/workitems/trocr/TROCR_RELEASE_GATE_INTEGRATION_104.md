...
**状態**: Completed・Closed。PR [#105](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/105)をSquash Merge・mainへ反映済み、Merge Commit: `363ba21`。Issue #104はPR本文の`Closes #104`によりマージ時に自動Close。
