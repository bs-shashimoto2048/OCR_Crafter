...
8. **TrOCR Evaluation** — Phase4（評価連携の方針決定・confidence算出方法の確定。**Epic [#27](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/27)管轄**。Design [#61](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/61)として設計**Completed**・Closed、[ADR-0003（Accepted）](../../adr/ADR-0003_Multi_Engine_Evaluation.md)確定。Common Evaluation Schema（Feature [#63](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/63)）は**Completed**・Closed（PR [#64](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/64)、Merge Commit: `4663dd0`）。Common Metric Calculator（Feature [#65](https://github.com/bs-shashimoto2048/OCR_Crafter/issues/65)）は実装済み・PRレビュー待ち。Evaluation Dispatcher / Runner以降は未着手）
