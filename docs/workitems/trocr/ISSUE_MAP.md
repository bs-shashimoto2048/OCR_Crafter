...
- （未作成）Model Metadata実運用化Epic: `ModelMetadata`の生成・保存・Models/Inference/Evaluation連携・旧モデル管理方式からの移行。TrOCRに限らない別責務のためEpic #27とは分離管理する
