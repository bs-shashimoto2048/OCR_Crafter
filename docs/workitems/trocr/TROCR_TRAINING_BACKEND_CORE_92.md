...
**状態**: Completed・Closed。PR [#93](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/93)をSquash Merge・mainへ反映済み、Merge Commit: `1684999`。Issue #92はPR本文の`Closes #92`によりマージ時に自動Close。
