...
**状態**: Completed・Closed。PR [#107](https://github.com/bs-shashimoto2048/OCR_Crafter/pull/107)をSquash Merge・mainへ反映済み、Merge Commit: `ddbcf91`。Issue #106はPR本文の`Closes #106`によりマージ時に自動Close。
