...
- **Release History**: Version/Model/Release Date/Author/Reason/Rollbackフラグの履歴（新しい順）。行の「このVersionへ戻す」で**Rollback**（確認後、過去Versionのモデルを再Production・新履歴エントリ）。**Version比較**（A/Bラジオ選択→2バージョンの実験条件差分を強調表示）
