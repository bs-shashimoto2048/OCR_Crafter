  ...
  return (
    ...
    >
      <div className="scroll-stable min-h-0 space-y-3 overflow-y-auto pr-1">
        <div className="rounded-xl border border-border bg-card/45 px-3 py-2">
          <p className="text-xs font-semibold text-text">基本パラメータ</p>
          <p className="text-[11px] text-muted">日常の調整はこのブロックだけで完結します。</p>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card/45 p-3">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-xs font-semibold text-text">詳細パラメータ</p>
              <p className="text-[11px] text-muted">実験用途の項目です。必要な時だけ展開してください。</p>
            </div>
            <Button size="sm" variant="secondary" onClick={() => setShowAdvanced((prev) => !prev)}>
              {showAdvanced ? "詳細を閉じる" : "詳細を開く"}
            </Button>
          </div>
        </div>
