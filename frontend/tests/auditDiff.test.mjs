...
test("監査アクションの日本語ラベル（基本13種＋バックアップ2種＋補完7種＋レポート2種＋前処理設定保存2種=26種）", () => {
  assert.equal(Object.keys(AUDIT_ACTION_LABELS).length, 26);
  ...
  assert.equal(AUDIT_ACTION_LABELS.preprocess_config_save, "前処理設定保存");
  assert.equal(AUDIT_ACTION_LABELS.preprocess_config_restore, "前処理設定復元");
});
